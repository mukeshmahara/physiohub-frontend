...
export const privateRoutes = [
  ...
  { path: "/patients/active", component: Patients },

  { path: "/appointments", component: Appointment },
  { path: "/appointments/calendar", component: Appointment },
  { path: "/appointments/calender", component: Appointment },
  { path: "/appointments/todays", component: Appointment },
  { path: "/appointments/today", component: Appointment },
  { path: "/appointments/upcoming", component: Appointment },
  { path: "/appointments/waiting", component: Appointment },
  { path: "/doctors", component: Doctor },
  { path: "/settings", component: Setting },
  { path: "/treatments", component: Treatment },
  { path: "/treatments/plans", component: Treatment },
  { path: "/treatments/history", component: Treatment },
